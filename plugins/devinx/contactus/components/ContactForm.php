...
class ContactForm extends ComponentBase{
    ...
    public function onRun(){
        ...
        $this->page["phone_input"] = Settings::get('phone_input');
        $this->page["projectname_input"] = Settings::get('projectname_input');
        $this->page["projectdescription_input"] = Settings::get('projectdescription_input');
        $this->page["website_input"] = Settings::get('website_input');
        $this->page["location_input"] = Settings::get('location_input');
        $this->page["projectsector_input"] = Settings::get('projectsector_input');
        $this->page["done_input"] = Settings::get('done_input');
        $this->page["development_input"] = Settings::get('development_input');
        $this->page["support_input"] = Settings::get('support_input');
        $this->page["team_input"] = Settings::get('team_input');
        $this->page["hear_input"] = Settings::get('hear_input');
